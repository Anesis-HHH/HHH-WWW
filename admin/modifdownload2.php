...
require dirname(__FILE__).'/../classes/ProjetManager2.php';
...
<div id="main">
	...
	if(isset($_GET['idModDow']))
	{
		...
		{
	?>
		<form action="action/moddownload2.php" method="post">
			<p>
			Titre du projet :
			<select name="titre">
				<?php
			...
			<p>
				Check :
				<input type="text" name="checkeur" value="<?php echo $formu['checkeur']; ?>" />
			</p>
			<p>
				Édition :
